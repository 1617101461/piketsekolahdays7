		...
		<div class="container">
			<div class="col-md-12">
				<div class="panel panel-primary">
					<div class="panel-heading">Edit Siswa
					...
					<div class="panel-body">
						...
						<div class="form-group {{$errors->has('nis') ? 'has-error' : ''}}">
			  			...
			  			<select name="id_kelas" class="form-control">
			  				...
			  				@php
			  				$selectedkelas = App\kelas::findOrFail($data->id)->id_kelas
			  				@endphp
                        ...
                        @endif
							...
							<div class="form-group {{$errors->has('jk') ? 'has-error' : ''}}">
								...
								<input type="radio" name="jk" class="flat" value="Laki-aki" {{ $siswas->jk == 'laki-laki' ? 'checked' : '' }}> Laki-laki
